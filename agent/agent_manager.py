...
def start_agent(host,port=12345, alert_port=12346,task_port=12345,iperf_port = 5202):
    ...
    try:
        ...
        process_tasks(client_socket, task_executor)
...
def stop_iperf_server():
    """Finaliza o servidor iperf."""
    global iperf_process
    if iperf_process:
        print("[IPERF] Encerrando o servidor iperf...")
...
def process_tasks(client_socket, task_executor):
